...
for i in range(0,episodes):
    ...
    if i %20 ==0:
        torch.save(player.policy_net.state_dict(),"weights_%s_%d_wimblepong_DQN_5.mdl" % ("bro", i)) 
        torch.save(player.optimizer.state_dict(),"optimizer_%s_%d_wimblepong_DQN_5.mdl" % ("bro", i)) 
